...
/**
 * Flat Nostress Gpwebpay transactions collection
 *
 * @category   Nostress
 * @package    Nostress_Gpwebpay
 * @author     NoStress Commerce Team <info@nostresscommerce.cz>
 */
class Nostress_Gpwebpay_Model_Resource_Transactions_Collection extends Nostress_Gpwebpay_Model_Resource_Collection_Abstract
{
    /**
     * Event prefix
     *
     * @var string
     */
    protected $_eventPrefix    = 'nostress_gpwebpay_transactions_collection';
     ...
     * @var string
     */
    protected $_eventObject    = 'transactions_collection';
     ...
     *
     * @return Nostress_Gpwebpay_Model_Resource_Transactions_Collection
     */
     ...
     *
     * @return Nostress_Gpwebpay_Model_Resource_Collection_Abstract
     */
