 ...
 */
class Nostress_Gpwebpay_Model_Resource_Transactions_Status_History_Collection extends Nostress_Gpwebpay_Model_Resource_Transactions_Collection_Abstract
{
    /**
     * Event prefix
     *
     * @var string
     */
    protected $_eventPrefix    = 'nostress_gpwebpay_transactions_status_history_collection';
     ...
     * @var string
     */
    protected $_eventObject    = 'transactions_status_history_collection';
     ...
     */
    public function getUnnotifiedForInstance($instance, $historyEntityName=Nostress_Gpwebpay_Model_Transactions::HISTORY_ENTITY_NAME)
    {
        if(!$instance instanceof Nostress_Gpwebpay_Model_Transactions) {
            $instance = $instance->getTransaction();
        }
        $this->setTransactionFilter($instance)->setTransaction('created_at', 'desc')
