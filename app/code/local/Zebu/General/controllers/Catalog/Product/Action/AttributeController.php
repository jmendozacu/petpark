...
class Zebu_General_Catalog_Product_Action_AttributeController extends Mage_Adminhtml_Catalog_Product_Action_AttributeController
{
    ...
    public function saveAction()
    {
        ...
        try {
            ...
            if ($inventoryData) {
             ...
             if (isset($attributesData['availability_out']) || $inventoryData){
                foreach($this->_getHelper()->getProductIds() as $id){
                  $availObs = new Zebu_General_Model_Observer();
                  $availObs->updateAvailability($id);
                } 
             }
