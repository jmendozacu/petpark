...
class Virtua_Optimization_Model_Resource_Product_Type_Configurable_Attribute_Collection
    extends Mage_Catalog_Model_Resource_Product_Type_Configurable_Attribute_Collection
{
    /**
     * The variable contains pricings values to prevent executing scripts unnecessarily times
     *
     * @var array
     */
    ...
    protected function _loadPrices()
    {
        if ($this->count()) {
            ...
            if (
                ...
                isset(self::$_pricings[$this->getProduct()->getId()])
            ) {
