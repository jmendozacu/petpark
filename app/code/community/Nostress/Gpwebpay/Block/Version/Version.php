 ...
 */
class Nostress_Gpwebpay_Block_Version_Version extends Mage_Adminhtml_Block_System_Config_Form_Field
{
	public function render(Varien_Data_Form_Element_Abstract $element) {
		return Mage::helper(strtolower($this->getModuleName()).'/version')->getDashboardEntryHtml();    	    	
	}
}