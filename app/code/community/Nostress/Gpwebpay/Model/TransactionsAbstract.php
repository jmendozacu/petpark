...
/**
 * Transactions abstract model
 *
 * @category   Nostress
 * @package    Nostress_Gpwebpay
 * @author     NoStress Commerce Team <info@nostresscommerce.cz>
 */
abstract class Nostress_Gpwebpay_Model_TransactionsAbstract extends Mage_Core_Model_Abstract
{
	...
	*/
	...
	/**
	* Get object updated at date affected current active store timezone
	*
	* @return Zend_Date
	*/
	public function getUpdatedAtDate() {
		return Mage::app()->getLocale()->date(
			Varien_Date::toTimestamp($this->getUpdatedAt()),
			null,
			null,
			true
		);
