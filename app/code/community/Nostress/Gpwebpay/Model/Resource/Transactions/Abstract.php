...
/**
 * Flat Gpwebpay transactions abstract
 *
 * @category   Nostress
 * @package    Nostress_Gpwebpay
 * @author     NoStress Commerce Team <info@nostresscommerce.cz>
 */
abstract class Nostress_Gpwebpay_Model_Resource_Transactions_Abstract extends Nostress_Gpwebpay_Model_Resource_Abstract
{
    /**
     * Is grid available
     *
     ...
     * @var string
     */
    protected $_eventPrefix                  = 'nostress_gpwebpay_resource';
     ...
     * @param string $column
     * @return Nostress_Gpwebpay_Model_Resource_Transactions_Abstract
     */
