 ...
 */
class Nostress_Gpwebpay_Model_Resource_Gpwebpay extends Nostress_Gpwebpay_Model_Resource_Abstract
{
	/**
	* Event prefix
	*
	...
	* @var string
	*/
	protected $_entityCodeForIncrementId     = '';
	...
	*/
	protected function _construct() {
		$this->_init('nostress_gpwebpay/nostress_gpwebpay', 'verify_id');
	}
}
