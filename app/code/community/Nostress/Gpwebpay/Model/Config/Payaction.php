...
/**
 * Config Payaction model
 *
 * @category   Nostress
 * @package    Nostress_Gpwebpay
 * @author     NoStress Commerce Team <info@nostresscommerce.cz>
 */
class Nostress_Gpwebpay_Model_Config_Payaction
{
	public function toOptionArray() {
		...
		return array(
			...
			array('value' => 1, 'label' => Mage::helper('nostress_gpwebpay')->__('Authorization')),
			array('value' => 2, 'label' => Mage::helper('nostress_gpwebpay')->__('Deposit'))
		);
	}
}
